...
|-----------------|-----------------|---------------------|----------------------|-----------|--------------|-----------|--------------------|
|  2023/08        | all.json.tar.gz | cr_instant.snapshot | schema_crossref.json | [Repo](https://github.com/naustica/crossref_bq) |  26.09.2023  | 2013-2023 | 43.624.702 |
...
| 2023-08-18 | works/        | openalex.works        | schema_openalex_work.json         | [Repo](https://github.com/naustica/openalex) |  24.08.2023  | All | 243.053.925 |
